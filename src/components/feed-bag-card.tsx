...
export default function FeedBagCard({ feedBag, refresh }: any) {
  ...
  return (
    <motion.div
      ...
      className="bg-linear-to-br from-rose-600/75 via-orange-400/55 to-yellow-500/55 border border-white/20 backdrop-blur-xl p-6 md:p-7 rounded-2xl shadow-2xl space-y-4 hover:-translate-y-1 hover:shadow-2xl transition-transform duration-300"
    >
